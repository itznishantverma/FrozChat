...
export default function ChatWindow({ roomId, currentUser, partnerUser, isFriendChat = false, isTemporarilyClosed = false, customNavbarActions, showMenuWhenClosed = false }: ChatWindowProps) {
      ...
      <div className="flex-shrink-0 flex items-center justify-between px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 border-b border-cyan-200 bg-white backdrop-blur-sm shadow-sm z-20">
        <div className="flex items-center gap-1 sm:gap-2 md:gap-4 min-w-0 flex-1">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 min-w-0 flex-1">
            <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full flex items-center justify-center flex-shrink-0">
